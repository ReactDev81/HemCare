    ...
    return(
        <View className='flex-1 items-center justify-center bg-white w-full px-[30px]'>
            <View className='py-3'>
                ...
                <Text className="text-sm leading-[22px] font-normal text-blue-light text-center mt-2 mb-7">Keep your haemophilia records organized and accessible. Record your bleeds, treatments, and important information in one convenient place.</Text>
